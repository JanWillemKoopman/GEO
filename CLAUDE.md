...
npm run test:unit        # 1744 tests, pure functies, geen DB/API-key
...
| `docs/modulekaart.md` | **Waar zit wat, en wat pakken we als eerste op.** De app in dertien domeinen en 56 deep dives, elk met de bestanden, de afhankelijkheden en vijf vragen. Achteraan staan de 56 op volgorde van potentie, nummer 1 eerst. Verwijst voor het hoe naar `architecture.md` en herhaalt die feiten niet |
