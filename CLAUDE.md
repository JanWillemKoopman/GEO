...
npm run test:unit        # 1154 tests, pure functies, geen DB/API-key
npm run test:chain       # 119 ketentests, echte handlers tegen echte Postgres, geen netwerk
...
supabase/migrations/  0001-0054 (0033 gereserveerd, nooit gedraaid, vervangen door 0039)
