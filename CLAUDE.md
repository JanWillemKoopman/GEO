...
| `docs/tasks/` | Wat er nog open staat: `ontwikkelplan-visie.md` (het plan van vandaag naar `visie.md`, in tien sprints, leidend voor de volgorde, met `ontwikkelplan_naar_eindproduct.html` als leesbare versie ernaast), `mijn-reputatie.md` (het product- en implementatieplan voor de reputatieanalyse onder Analytics, met `mijn-reputatie.html` als leesbare versie ernaast), `acquisitie-module.md` (het bespreekstuk voor de acquisitiemodule: een publiek GEO-marktrapport per branche en plaats plus een persoonlijke openingsmail, voor New business en de engineers die het bouwen), `roadmap.md` (het oudere, kleinere openstaande werk), `potentiescore.md` en `verificatie-r8-s8.md`. **Tijdelijk van aard:** af is weg, samengevat in `logbook.md` |
