 ...
 *
 * 1. Versie 1 is altijd "door Aura geschreven": er is nog niets te herschrijven.
 ...
 *    komt uit de automatische kritiekronde: Aura herschreef zichzelf.
 */
export function versionReasonOf(input: VersionReasonInput): VersionReason {
  if (input.version <= 1) {
    return { kind: "origineel", label: "Door Aura geschreven" };
  }
  ...
  return { kind: "herschreven", label: "Door Aura herschreven na eigen kritiekronde" };
}
