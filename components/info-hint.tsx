    ...
    <span ref={wrapRef} className="relative inline-flex">
      ...
      {open && (
        <span
          id={panelId}
          role="note"
          className="menu-surface absolute left-0 top-8 z-20 block w-64 rounded-[var(--radius-md)] border border-[var(--border-subtle)] p-3 text-sm font-normal text-secondary shadow-[var(--shadow-overlay)]"
        >
