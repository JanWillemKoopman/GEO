...
export function OpenQuestionsBadge({
  ...
  return (
    <Link
      ...
      title={label}
      aria-label={label}
      className="flex items-center gap-2 rounded-[var(--radius-md)] px-2 py-1 text-sm text-secondary transition-colors hover:bg-[var(--interactive-hover)] hover:text-[var(--text-primary)]"
    >
