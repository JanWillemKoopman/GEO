...
hoofdstuk 04 benoemt in zijn eigen tekst nog steeds dat hij hoofdstuk 01 voedt, alleen niet meer
met schermruimte. Zie `docs/logbook.md` 26 augustus 2026 voor de volledige afweging.
...
(`components/section-rail.tsx`, verticaal, met scroll-spy): die draait nog op het
onboardingscherm, dat wél één doorlopende pagina blijft.
