...
(Nova, Aura, InSpace, "Stratosphere", "Milky Way", "Universe Access", "Growth lab") en nooit in de
...
### 3. Aura is een handelend onderwerp, geen "systeem"
Nova schrijft over zichzelf in de derde persoon, als iets dat werkt: *"Nova leert eerst je bedrijf
kennen"*, *"Het schrijft de content"*, *"Nova blijft kijken naar rankings"*. Dus: **"Aura leest je
website uit"**, niet "de website wordt uitgelezen". Actief, met Aura of jij als onderwerp, nooit
lijdend.
...
draagt het model expliciet op om beide tekens weg te laten. Zonder die regel schrijft Aura pagina's
...
|---|---|
| Aura | GEO Tracker, "de app", "het systeem", "de tool" |
...
| vragen (die Aura aan de AI stelt) | prompts, queries |
...
- **Automatisch publiceren naar een CMS.** Nova's `04 Automated publishing` en de CMS-logo's
  (Shopify, WordPress, …) hebben wij niet. Aura schrijft de pagina en levert hem klaar op; de klant
  plaatst hem zelf. De copy belooft dus nergens een koppeling.
- **"Volledig autonoom".** Aura vraagt bewust om goedkeuring vóór er gemeten en gepubliceerd wordt.
  Waar Nova "autonomous" zegt, zeggen wij "Aura doet het werk, jij zet de knopen door".
- **Klassieke SEO-taal** (rankings, keywords, posities in Google). Aura is een GEO-product: het gaat
...
1. **De naam zelf**, dus Aura, en het gradient-woord in een kop.
