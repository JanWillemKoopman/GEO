...
>
> **Wat hieronder NIET meer klopt** (stap 1, 2, 4, 5 en 6 zijn doorgevoerd):
>
> | Hoofdstuk | Status |
> |---|---|
...
>
> **Wat hieronder nog WEL klopt**, want stap 7 tot 11 zijn nog niet gedaan: §6b (iconen, lijndikte
...
>
> **Sinds stap 5 en 6 is er een mobiel ontwerp dat dit document nergens beschrijft.** Een telefoon
...
> `isTelefoon()` (`lib/apparaat.ts`, stap 5). Dit document behandelt uitsluitend de desktopopbouw; het
> mobiele ontwerp staat volledig in `redesign2026.md` §8.12 en de stappen 5 tot 7 van §10.2.
>
