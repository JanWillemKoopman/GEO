...
K5 op productie nalopen lukte deze sessie niet (26 september 2026). Het vraagt een antwoord, de open vraag van een pagina en een veld op het gespreksscherm, en dat kan alleen ingelogd in de app; de beveiliging van de werkomgeving liet inloggen op productie niet toe. Daarnaast heeft het proefmerk Fysiotherapie West Maas en Waal nog geen pagina, dus ook geen open vraag: daarvoor is eerst een meting nodig (ongeveer $0,82). Een wijziging van een antwoord bij Autorijschool Pompert start geen nieuwe schrijfbeurt, want al zijn pagina's zijn klaar; daar kan de proef dus zonder kosten. De K6-voorwaarde van besluit V16 staat nog: 20 open punten in `kennislaag-open-punten.md`.
