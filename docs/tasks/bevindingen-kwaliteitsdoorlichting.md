...
| 56 | **hoog** | Een analyse wordt al na de eerste mislukte rapportpoging op "vastgelopen" gezet en toont de klant een foutmelding, terwijl de taak zelf nog drie keer op de achtergrond opnieuw probeert (tot 30 minuten) | ✅ opgelost, PR #PRNUM (25 september 2026) |
...
**Opgelost (25 september 2026, PR #PRNUM).** De tweede weg uit het voorstel: `generateReport()` zet de
