...
| Werkpakket | Stand |
|---|---|
| WP9 | Eerste stap (25 september 2026): de eigenaarstoets (L10) als vijfde beoordelaar bij een pagina met strategie, op Sol; "nee" blokkeert, problemen met een letterlijk citaat gaan als bevinding de reparatie in (`eigenaarstoets.ts`). De merkstemtoets (L9) en het vervangen van de redactie- en vakmanschapsbeoordelaar volgen na de nameting |
