  ...
  if (pieces.length === 0) {
    return (
      <EmptyState
        ...
        action={{ href: `/analyses/${id}`, label: "Kies wat ORBIT ENGINE gaat schrijven" }}
      >
        Zodra je op het cluster pagina&apos;s kiest, stelt ORBIT ENGINE hier de vragen die het nodig heeft
  ...
  if (questions.length === 0 && alleenGroen) {
    return (
      <div className="card card-success flex flex-col gap-3">
        <h2 className="type-title">ORBIT ENGINE weet genoeg</h2>
