...
export default function Loading() {
  return (
    <div className="flex flex-col gap-6" aria-busy="true" aria-label="Bezig met laden">
      <Skeleton className="h-32" style={{ borderRadius: "var(--radius-xl)" }} />
      <Skeleton className="h-48" style={{ borderRadius: "var(--radius-xl)" }} />
      <Skeleton className="h-56" style={{ borderRadius: "var(--radius-xl)" }} />
    </div>
  );
}
