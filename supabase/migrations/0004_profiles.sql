...
create table public.profiles (
  ...
  proof_points   text[] not null default '{}', -- contentkwaliteit A2: citeerbare feiten uit de site (verhuisd van brand_dna, migratie 0003)
  style_samples  text[] not null default '{}', -- contentkwaliteit A3: letterlijke stijlvoorbeelden
...
-- ── brand_dna vervalt: het bedrijfsbrede deel (incl. de contentkwaliteit-
-- kolommen proof_points/style_samples uit migratie 0003) zit nu in profiles ──
