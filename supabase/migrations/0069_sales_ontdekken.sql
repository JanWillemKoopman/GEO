-- ═══════════════════════════════════════════════════════════════════════════
-- 0069 · De Sales-module, sprint 2: de markt ontdekken en uitsluiten wie er
--        niet in hoort
-- ═══════════════════════════════════════════════════════════════════════════
--
-- WAT DIT TOEVOEGT
...
-- tabellen uit `0068`. Het ontwerp staat in `docs/tasks/geo-prospect-engine.md`
...
-- NUMMER GAF
--
-- Zodra `0068` op productie heeft gedraaid, ligt hij vast: er staan rijen in en
...
--
-- Zelfde regel als in 0068: select-only, alleen voor `is_sales()`, en `to
