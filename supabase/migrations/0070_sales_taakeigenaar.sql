-- ═══════════════════════════════════════════════════════════════════════════
-- 0070 · Een taak mag ook aan een MARKT hangen
-- ═══════════════════════════════════════════════════════════════════════════
--
...
--
-- De Sales-module (migraties `0068` en `0069`) plant taken in die bij een MARKT
...
comment on column public.jobs.sales_market_id is
  'Bij welke marktanalyse hoort deze taak (migratie 0069). De derde soort eigenaar '
